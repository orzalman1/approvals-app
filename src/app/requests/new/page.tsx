...
const EMPTY_ITEM: Item = {
  ...
  supplier: '', purchaseQty: '', purchasePrice: '',
  excess: '', itemStatus: '', notes: '',
}
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200 text-gray-600 text-xs">
                    <th className="text-right py-2 px-2 font-medium w-44">מק"ט</th>
                    <th className="text-right py-2 px-2 font-medium w-40">תיאור</th>
                    <th className="text-right py-2 px-2 font-medium w-24">תאריך נדרש</th>
                    <th className="text-right py-2 px-2 font-medium w-20">כמות נדרשת</th>
                    <th className="text-right py-2 px-2 font-medium w-24">ספק</th>
                    <th className="text-right py-2 px-2 font-medium w-20">כמות רכישה</th>
                    <th className="text-right py-2 px-2 font-medium w-20">מחיר</th>
                    <th className="text-right py-2 px-2 font-medium w-20">Excess</th>
                    <th className="text-right py-2 px-2 font-medium w-24">סטטוס</th>
                    <th className="w-6"></th>
                  </tr>
                </thead>
                <tbody>
                  {items.map((item, i) => (
                    <tr key={i} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-1 px-2">
                        <input type="number" value={item.purchaseQty}
                      ...
                      <td className="py-1 px-2">
                        <input type="number" value={item.excess}
                          onChange={e => updateItem(i, 'excess', e.target.value)}
                          className="w-full border border-gray-200 rounded px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-blue-400"
                          placeholder="0" />
                      </td>
                      <td className="py-1 px-2">
                        <input value={item.itemStatus}
